...
export const tileflowIconSpriteIndexEntrySchema = z.object({
...
export const tileflowIconSpriteIndexSchema = z.record(tileflowIconIdSchema, tileflowIconSpriteIndexEntrySchema).refine(
	(index) => Object.keys(index).length > 0 && Object.keys(index).length <= tileflowIconPackageLimits.maxIconCount,
