...
graphs. Streets and Ferraris are independent root maps; Streets Dark, Cyberpunk, and Verdant are
ordinary maps derived from Streets.
...
4. Migrate the Streets and Ferraris roots, then Streets Dark, Cyberpunk, and Verdant away from
   public/raw physical overrides and captured data bindings into typed modules or owner-scoped
   compiler semantic contributions.
...
- All five official maps under canonical, fully remapped, missing-optional, and missing-required
  data schemas.
...
- Maps publication dry-run includes `@tileflow/maps`, all five official icon directories,
  Cyberpunk's exact font files, and its adjacent license.
...
- The sibling tileflow-tiles playground currently exercises four of the five official maps and
