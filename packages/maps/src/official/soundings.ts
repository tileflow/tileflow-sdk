...
export const soundingsTheme = {
  ...
  modules: {
    ...
    poi: {
      ...
      services: soundingsPalette.ink,
      transit: soundingsPalette.magenta,
    },
    roads: {
      ferry: soundingsPalette.waterInk,
...
/**
 * A self-contained nautical-chart map. It shares only Tileflow's public
 * compiler contract; it neither imports nor extends the Streets map.
 *
 * GEBCO supplies broad bathymetric bands rather than navigation-grade survey
 * soundings. Dashed band edges and range labels are therefore contextual and
 * this map must not be used for navigation. Exact aids to navigation render
 * only when the source data exposes their matching semantic POI classes.
 */
export const soundings = defineRootMap({
  id: 'soundings',
  version: 1,
  name: 'Soundings',
  ...
  modules: {
    ...
    poi: poi({
      ...
      classMapping: {
        harbor: ['harbor', 'harbour', 'marina'],
        'ferry-terminal': ['ferry_terminal', 'ferry-terminal'],
        lighthouse: ['lighthouse', 'light_house'],
        light: ['navigation_light', 'light'],
        'buoy-port': ['buoy_port', 'buoy-port'],
        'buoy-starboard': ['buoy_starboard', 'buoy-starboard'],
        'buoy-cardinal': ['buoy_cardinal', 'buoy-cardinal'],
        wreck: ['wreck'],
        'rock-awash': ['rock_awash', 'rock-awash', 'reef'],
      },
      color: 'uniform',
      density: 'dense',
      icons: 'full',
      labels: 'full',
      minZoom: 10,
      placement: {coupleIconAndLabel: false, iconPadding: 4, textPadding: 3},
      preset: 'full',
      styles: {
        harbor: nauticalPoiStyle('soundings-harbor', soundingsPalette.waterInk, 10, 76),
        'ferry-terminal': {
          minZoom: 11,
          priority: 84,
          icon: {visible: false},
          marker: {
            ...
            strokeColor: soundingsPalette.water,
            strokeOpacity: 1,
            strokeWidth: 1.25,
          },
          text: {
        ...
        lighthouse: nauticalPoiStyle('soundings-lighthouse', soundingsPalette.ink, 10, 96),
        light: nauticalPoiStyle('soundings-light-flare', soundingsPalette.magenta, 11, 94),
        // Keep lateral marks neutral until the source carries authoritative IALA region/colour.
        'buoy-port': nauticalPoiStyle('soundings-buoy-port', soundingsPalette.ink, 12, 92),
        'buoy-starboard': nauticalPoiStyle(
          'soundings-buoy-starboard',
          soundingsPalette.ink,
          12,
          92,
        ),
        'buoy-cardinal': nauticalPoiStyle('soundings-buoy-cardinal', soundingsPalette.ink, 12, 92),
        wreck: nauticalPoiStyle('soundings-wreck', soundingsPalette.ink, 11, 90),
        'rock-awash': nauticalPoiStyle('soundings-rock-awash', soundingsPalette.ink, 12, 90),
      },
    }),
