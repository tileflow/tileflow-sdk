...
export const ferrarisTheme = {
  ...
  modules: {
    ...
    poi: {
      coffee: ferrarisPalette.inkMuted,
      culture: ferrarisPalette.boundary,
      education: ferrarisPalette.inkMuted,
      food: ferrarisPalette.boundary,
      halo: ferrarisPalette.halo,
      health: ferrarisPalette.boundary,
      icon: ferrarisPalette.ink,
      label: ferrarisPalette.ink,
      lodging: ferrarisPalette.boundaryMuted,
      services: ferrarisPalette.inkMuted,
      shopping: ferrarisPalette.inkMuted,
      transit: ferrarisPalette.rail,
    },
    roads: {
 ...
 */
export const ferraris = defineRootMap({
  id: 'ferraris',
  version: 1,
  name: 'Ferraris',
  ...
  ...defineModuleEffects([
    ...
    landcoverPattern('wood', 'land.landcover.wood.fill', 'ferraris-woodland', ['wood', 'forest'], {
      minZoom: 8,
      opacity: 0.82,
    }),
    landusePattern(
