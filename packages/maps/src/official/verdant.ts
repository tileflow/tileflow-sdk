...
export const verdantTheme = defineOfficialTheme({
  ...
  modules: {
    ...
    poi: {
      'arts-entertainment': verdantPalette.trail,
      education: verdantPalette.woodDark,
      'food-drink': verdantPalette.trailMuted,
      halo: verdantPalette.halo,
      icon: '#385A48',
      label: verdantPalette.ink,
      landmark: verdantPalette.trail,
      lodging: verdantPalette.woodDark,
      medical: verdantPalette.trail,
      'park-nature': verdantPalette.woodDark,
      'public-services': verdantPalette.inkMuted,
      religion: verdantPalette.trail,
      retail: verdantPalette.woodDark,
      'sport-leisure': verdantPalette.trailMuted,
      transport: verdantPalette.rail,
      'visitor-amenity': verdantPalette.inkMuted,
    },
    roads: {
