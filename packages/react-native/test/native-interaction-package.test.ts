...
test('the workspace edge and private build entry do not broaden the public component contract', async () => {
	...
	assert.doesNotMatch(declarations, /NativeInteraction|NativePoi|onInteractionStateChange|defaultInteractionState|annotations\??:/u);
