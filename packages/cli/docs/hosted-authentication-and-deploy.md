...
atlas bytes and sorted icon names are public. Each hosted package is limited to 1,000 icons and 8 MiB
generated bytes as a processing envelope. Large artwork may reach the 2,048-pixel atlas bound before
the icon count. There is no package-count quota; physically retained
